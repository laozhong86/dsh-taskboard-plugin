window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function mountTaskboardEntry(ctx) {
		  ...
		  entry.innerHTML = `<span class="dsh-taskboard-entry-icon">${TASKBOARD_ICON_SVG}</span><span class="dsh-taskboard-entry-label">Taskboard</span>`;
