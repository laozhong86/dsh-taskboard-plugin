...
export class TaskboardDatabase {
  ...
  #migrate() {
    ...
    this.database.exec(`
      UPDATE tasks
      SET creator_type = 'agent', creator_id = 'taskboard-agent', creator_name = 'Taskboard Agent'
    ...
    this.database.exec(`
      UPDATE comments
      SET author_type = 'agent', author_id = 'taskboard-agent', author_name = 'Taskboard Agent'
