---
name: taskboard
description: Manage Taskboard issues with taskctl. Use for issue IDs, status sync, comments, relations, or attachments on the local Taskboard—not for unrelated product docs.
---
